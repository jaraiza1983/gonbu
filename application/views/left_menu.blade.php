				...
				$metronic_left_aside_menu = new MetronicTopMenu(
					[
						new MetronicTopMenu_Option(["text"=>"Dashboard","icon" =>"flaticon-add","badge" => "B", "href" => "javascript:alert('x')"]),
						new MetronicTopMenu_Option(["text"=>"Section Title","isSection"=>true]),		
						new MetronicTopMenu_Option(["text"=>"Badge Button","icon"=>"flaticon-add","badge" =>"?","href" => "#action"]),
				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							@foreach($metronic_left_aside_menu->options as $left_aside_menu_option)
							
							@if($left_aside_menu_option->isSection)
							<!-- isSection -->
							<li class="m-menu__section ">
								<h4 class="m-menu__section-text">{{ $left_aside_menu_option->text }}</h4>
								<i class="m-menu__section-icon flaticon-more-v3"></i>
							</li>
							@else
								@if($left_aside_menu_option->href != "javascript:;")
								<!-- Link directo -->
								<li class="m-menu__item  m-menu__item--active" aria-haspopup="true">
									<a href="{{ $left_aside_menu_option->href }}" class="m-menu__link ">
										@isset($left_aside_menu_option->icon)
										<i class="m-menu__link-icon flaticon-line-graph"></i>
										@endisset
										<span class="m-menu__link-title">
											<span class="m-menu__link-wrap">
												<span class="m-menu__link-text">{{ $left_aside_menu_option->text }}</span>
												@isset($left_aside_menu_option->badge)
												<span class="m-menu__link-badge">
													<span class="m-badge m-badge--danger">{{ $left_aside_menu_option->badge }}</span>
												</span>
												@endisset
											</span>
										</span>
								...
								<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
									...
									<div class="m-menu__submenu ">
										...
										<ul class="m-menu__subnav">
											...
											@foreach($left_aside_menu_option->options as $left_aside_menu_sub_option)
											
											@empty($left_aside_menu_sub_option->options)
											<li class="m-menu__item " aria-haspopup="true">
												<a href="{{ $left_aside_menu_sub_option->href }}" class="m-menu__link ">
													<i class="m-menu__link-bullet m-menu__link-bullet--dot">
														<span></span>
													</i>
													<span class="m-menu__link-text">{{ $left_aside_menu_sub_option->text }}</span>
												</a>
											</li>
											@endempty
											
											@isset($left_aside_menu_sub_option->options)
											<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
												<a href="javascript:;" class="m-menu__link m-menu__toggle">
													<i class="m-menu__link-bullet m-menu__link-bullet--dot">
														<span></span>
												...
												<div class="m-menu__submenu ">
													<span class="m-menu__arrow"></span>
													<ul class="m-menu__subnav">
														@foreach($left_aside_menu_sub_option->options as $left_aside_menu_sub_sub_option)
														<li class="m-menu__item " aria-haspopup="true">
															<a href="{{ $left_aside_menu_sub_sub_option->href }}" class="m-menu__link ">
																<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																	<span></span>
																</i>
																<span class="m-menu__link-text">{{ $left_aside_menu_sub_sub_option->text }}</span>
															</a>
														</li>
														@endforeach														
													</ul>
